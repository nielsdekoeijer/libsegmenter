...
# Function for checking the constant-overlap-add (COLA) condition in the frequency domain.
# Example modified from Julius O. Smidth's website: https://ccrma.stanford.edu/~jos/sasp/Periodic_Hamming_OLA_Poisson_Summation.html

def checkCola(window, hopSize, plotFlag=False):
