...
for backend in ["torch", "tensorflow", "base"]:
    for mode in ["wola", "ola"]:
        for window_settings in [
            {"hop_size": 50, "window": libsegmenter.hamming(100), "input_size": (1000,)},
            {"hop_size": 50, "window": libsegmenter.hamming(100), "input_size": (1, 1000)},
            {"hop_size": 50, "window": libsegmenter.hann(100), "input_size": (1000,)},
            {"hop_size": 50, "window": libsegmenter.hann(100), "input_size": (1, 1000)},
            {"hop_size": 50, "window": libsegmenter.bartlett(100), "input_size": (1000,)},
            {"hop_size": 50, "window": libsegmenter.bartlett(100), "input_size": (1, 1000)},
            {"hop_size": 10, "window": libsegmenter.blackman(30), "input_size": (300,)},
            {"hop_size": 10, "window": libsegmenter.blackman(30), "input_size": (1, 300)},
        ]:
